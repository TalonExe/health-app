<script lang="ts">
  ...
  <div class="flex flex-col items-start justify-center gap-2">
    <div
      ...
      focus-within:ring focus-within:ring-magnum-400 border border-purple-300"
    >
      {#each $tags as t}
        <div
          use:melt={$tag(t)}
        ...
        >
          ...
          <button
            ...
            class="flex h-full items-center px-1 enabled:hover:bg-magnum-300 w-10"
          >
            <X class="size-3" />
          </button>
        </div>
